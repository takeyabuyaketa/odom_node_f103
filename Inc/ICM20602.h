...
//#define MPUREG_I2C_MST_STATUS      0x36 //ICM20602はI2C対応してないっぽい
#define MPUREG_FSYNC_INT 0x36
...
#define MPUREG_GYRO_ZOUT_L 0x48			//　　　　　　ここまでチェック済み
...
private:
	...
	uint8_t _spiWrite(const uint8_t data) const;
